...
//        {
//            // scale it a bit up
//            m_metaioMan->setScale(metaio::Vector3d(15.0f,15.0f,15.0f));
...
//    [self setVisibleChair:false];
    ...
    // load tv
    NSString* tvPath = [[NSBundle mainBundle] pathForResource:@"baymaxzoo"
													   ofType:@"obj"
												  inDirectory:@"tutorialContent_crossplatform/TutorialInteractiveFurniture/Assets"];
    if (tvPath)
    {
...
//        geometry->startAnimation( "shock_down", true);
    }
